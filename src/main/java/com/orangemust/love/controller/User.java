...
public class User {
    ...
    @PostMapping("login")
    public Result login(
            @ApiParam(name = "传入对象", value = "传入json格式", required = true) @Validated @RequestBody LoginReqVo loginReqVo,
    ...
    public Result register(
            @ApiParam(name = "传入对象", value = "传入json格式", required = true) @Validated @RequestBody RegisterReqVo registerReqVo) {
