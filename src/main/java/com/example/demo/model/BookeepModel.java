...
public class BookeepModel {
    ...
    @NotNull(message = "年份不能为空", groups = { BookeepGroups.MonthDetails.class, BookeepGroups.Insert.class, BookeepGroups.Update.class })
    @ApiModelProperty(value = "年", required = true)
    private Integer year;

    @ApiGroupProperty({BookeepGroups.MonthDetails.class, BookeepGroups.Insert.class, BookeepGroups.Update.class})
    @NotNull(message = "月份不能为空", groups = { BookeepGroups.MonthDetails.class, BookeepGroups.Insert.class, BookeepGroups.Update.class })
