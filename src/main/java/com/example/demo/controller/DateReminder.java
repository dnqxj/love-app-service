...
import com.example.demo.model.DateReminderModel;
import com.example.demo.response.Result;
import com.example.demo.swagger.annotation.ApiGroup;
import com.example.demo.utils.FuncUtil;
import com.example.demo.validate.group.DateReminderGroups;
...
public class DateReminder {
    ...
    public Result add(
            @ApiGroup(DateReminderGroups.Insert.class)
            @Validated(DateReminderGroups.Insert.class)
            @RequestBody DateReminderModel dateReminderModel,
...
//        插入数据库
    ...
    public Result update(
            @ApiGroup(DateReminderGroups.Update.class)
            @Validated(DateReminderGroups.Update.class)
            @RequestBody DateReminderModel dateReminderModel,
            HttpServletRequest request){
...
//        查找是否存在数据
    ...
    public Result delete(
            @ApiGroup(DateReminderGroups.Delete.class)
            @Validated(DateReminderGroups.Delete.class)
            @RequestBody DateReminderModel dateReminderModel,
            HttpServletRequest request
    ) {
        Long uid = FuncUtil.getUid(request);
